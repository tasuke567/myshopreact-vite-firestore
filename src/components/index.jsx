        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarsFurni">
            <ul className="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
              ...
              <li>
                <a className="nav-link" href="./src/shop.html">
                  Shop
                </a>
              </li>
            </ul>
            <ul className="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
              <li>
                <a className="nav-link" href="./src/crud.html">
                  <img src="images/user.svg" />
                </a>
              </li>
              <li>
                <a className="nav-link" href="./src/cart.html">
            ...
            <div className="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
              <div className="product-item-sm d-flex">
                ...
                <div className="pt-3">
                  ...
                  <p>
                    ไทเทเนียม ชิป A17 Pro ปุ่มแอ็คชั่น กล้องหลักความละเอียด 48MP
                    ซื้อเลย iPhone 15 Pro Max มาพร้อมการซูมแบบออปติคัล 5 เท่า
                    เรียกว่าสุดขอบเลยล่ะ...
                  </p>
                  <p>
                    <a href="#">Read More</a>
                  </p>
              ...
              <div className="product-item-sm d-flex">
                ...
                <div className="pt-3">
                  ...
                  <p>
                    ...
                    และกล้องถ่ายภาพกลางคืนปรับปรุงใหม่ พร้อมเก็บภาพได้ทุกโมเม้น.
                  </p>
                  <p>
                    <a href="#">Read More</a>
                  </p>
